package main.java.com.example.doctor.view;

import java.util.Scanner;

import main.java.com.example.doctor.controller.DoctorController;
import main.java.com.example.operation.view.OperationMenu;
...
public class DoctorMenu {
	 private final Scanner sc = new Scanner(System.in);
		...
		private void writePha() {
			...
			pc.writePha(str, pha, period, day,doctorName);
		}
		...
		private void writeMR() {
			...
			pc.writeRecords(str,diseaseName);
		}

package main.java.com.example.operation.view;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

import main.java.com.example.operation.controller.OperationController;
...
public class OperationMenu {
	 ...
	 private OperationController oc = new OperationController();
		...
		private void updateOp() {
			...
			oc.updateOp(patientName,date,newDate);
		}

package com.uni.section5.overloading;
...
public class Application {
	    ...
	    * */
	    ...
	    // 접근 제어자 public protected private   || 반환 값 void, int, double, STRING || 메소드 명 ||() 매개 변수의 타입 ,갯수, 순서 <> 오버라이딩 
		public void test() {}

//		public void test() {} // 컴파일 에러 -- 메소드의 시그니처가 동일한 경우
//		private void test() {} // 접근 제한자는 메소드 시그니처에 해당하지 않는다.
//		public int test() {return 0;} // return 형은 메소드 시그니처에 해당하지 않는다.
		
		public void test(int num) {}
//		public void test(int num22) //메소드 매개변수의 이름은 메소드 시그니처 x
		public void test(int num,int num2) {}  // 매개변수 갯수 차이에 따른 오버로딩
		public void test(int num,String str) {} // 매개변수 타입의 차이에 따른 오버로딩
		public void test(String str,int num) {}  // 매개 변수 순서에 따른 오버로딩
}

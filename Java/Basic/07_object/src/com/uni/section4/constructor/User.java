package com.uni.section4.constructor;
...
public class User {
	...
	private Date enrollDate;
	   ...
	   // 기본 생성자
	   // 동일한 이름의 생성자 혹은 메소드를 한클래스 내에서 작성하는 것은 불가능
	
		public User() {
			System.out.println("유저 클래스 기본 생성자 호출 carry");
		}
		//매개변수 있는 생성자
		public User(String id,String pwd,String name) {  // 오버로딩 : 매개변수의 타입, 갯수, 순서에 따라서 생성자나 메서드 한 클래스 안에 작성 가능.
			this.id = id;
			this.pwd = pwd;
			this.name = name;
		}
		...
		public User(String id, String pwd,String name,Date enrollDate) {
			...
			this(id,pwd,name);  // 반드시 첫 줄에 작성 (단 한번만 호출가능) == 요 안에서 생성자 호출
		...
		/**<pre>
		 ...
		 public User(User otherUser) {
				...
				// this 의 주소와 otherUser의 주소 다른지 확인.

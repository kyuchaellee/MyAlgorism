package com.uni.section3.array_copy;
...
public class Application3 {
	...
	public static void main(String[] args) {
		...
		//3.System의 arraycopy()를 이용
		int[] copyArr3 = new int[10];
		System.arraycopy(originArr, 0, copyArr3, 3, originArr.length); // 복사할 배열, 복사할 배열의 시작점, 복사될 배열, 복사될배열 시작점, 얼만큼 복사할 건지 순서임.
		print(copyArr3);
		
		//4. Arrays copyOf를 이용한 복사.
		int[] copyArr4 = Arrays.copyOf(originArr, 8); //원하는 길이 만큼 만들어서 복사할 수 있고 나머지엔 0이 드간다.
		print(copyArr4);

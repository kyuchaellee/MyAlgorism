...
public class Application1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("==========동적바인딩 확인 ===========");
	       ...
	       * */
		// 현재 레퍼런스 변수 타입은 animal 이기 때문에 rabbit과 tiger 의 고유 기능은 동작 못한다.
		a1.eat();
		a1.run();
		a1.cry();
		...
		/* 객체별로 고유한 기능을 동작시키기 위해서는 레퍼런스 변수를 형변환하여 Rabbit과 Tiger로 변경해야
	       ...
	       *  */
		// 래퍼런스 변수가 참조하는 실제 인스턴스가 원하는 타입과 맞는지 비교하는 연산자 instanceof
		...
		System.out.println("instanceof 확인 ----------------------------");
	      ...
	      Animal animal1 = (Animal)new Rabbit();// 업 캐스팅
	      Animal animal2 = new Rabbit(); //up casting 묵시적 형 변환
	      
	      Rabbit rabbit1=(Rabbit)animal1;  		  
//	      Rabbit rabbit2=animal2;		down casting은 묵시적 형변환이 안됨.  
	}
}

...
//		Product pro = new Product();  -- 추상클래스는 인스턴스 생성이 불가능하다.
		SmartPhone gal = new SmartPhone(); // 추상클래스 상속받은 객체를 이용
		
		System.out.println(gal instanceof SmartPhone);
		System.out.println(gal instanceof Product);
